  ...
  <b-card title="Order Items" class="cart-container">
    ...
    <b-card-footer>
      <b-alert v-model="createdOrder" variant="success" dismissible>
        Order was <b>{{ createdOrder.orderCode }}</b> created successfully!. Navigate to orders to see your order details
        and status, or proceed to add new items to create a new order.
      </b-alert>
